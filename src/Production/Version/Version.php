...
use Publisher\Fundamentals\Release\Version as DBVersion;

class Version implements Production
{
    ...
    {
        try {
            $store = $attributes ? DBVersion::create([
    ...
    {
        if($this->modelData instanceof DBVersion) return $this->modelData->toArray();
